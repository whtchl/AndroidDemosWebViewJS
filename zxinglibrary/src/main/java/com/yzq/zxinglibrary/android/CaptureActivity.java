...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void handleDecode(Result rawResult) {
        ...
        postTransScanEntity(rawResult.getText(),true);
    ...
    private void postTransScanEntity(String str,Boolean isSuccess){
        TransScanEntity transScanEntity = new TransScanEntity();
        //transScanEntity.setType(CaptureActivity.scan_type);
        transScanEntity.setSuccess(isSuccess);
        transScanEntity.setResult(str);
        ...
        if (requestCode == Constant.REQUEST_IMAGE && resultCode == RESULT_OK) {
            ...
            new DecodeImgThread(path, new DecodeImgCallback() {
                ...
                public void onImageDecodeFailed() {
                    ...
                    postTransScanEntity("抱歉，解析失败,换个图片试试.",false);
                    finish();
                }
            }).run();
