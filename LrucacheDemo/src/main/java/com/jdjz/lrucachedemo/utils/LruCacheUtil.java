...
public class LruCacheUtil {
    ...
    public LruCacheUtil(ListView listView) {
        ...
        Log.i("jdjz","cacheSize:"+cacheSize);
        mCache = new LruCache<String,Bitmap>(cacheSize){
            @Override
            protected int sizeOf(String key,Bitmap value){
                //Bitmap的实际大小 注意单位与maxMemory 一致
    ...
    public void showImageByAsyncTask(ImageView iv, final String url){
        Log.i("tchl","showImageByAsyncTask");
        //从缓存中取出图片
    ...
    public void loadImages(int start,int end){
        for(int i=start;i<end;i++){
            ...
            if(bitmap == null){
                ...
                //如果缓存中有 直接设置
                Log.i("tchl","loadImages Tag url:"+url);
    ...
    private class NewsAsyncTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            Log.i("tchl","LruCacheUtil  doInBackground:");
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            Log.i("tchl","onPostExecute Tag url:"+url);
            ImageView imageView = (ImageView) mListView.findViewWithTag(url);
